...
//feature info icon
let markerIcon = 'https://openlayers.org/api/2.13.1/img/marker.png';
//address search icon
let googleIcon = imageFolder + '/fahne.gif';

let mercator = 'EPSG:3857';
let geographic = 'EPSG:4326';
let projWGS = 'EPSG:4326';
let nzmapgrid = 'EPSG:27200';
let projNZ = 'EPSG:27200';
