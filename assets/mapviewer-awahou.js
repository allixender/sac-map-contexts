...
// var projGOO = new Proj4js.Proj('GOOGLE');
var projNZ = new Proj4js.Proj('EPSG:27200');

/* this stores the pre defined map context at the moment. */
/* TODO put that into a real datamodel */
/* TODO get region coordinates out of switchregion array in mapviewer20.js */
/* TODO extract magic id strings */
var currentContext = "awa";
var mapContextSpecs = [
...
//region: 'New Zealand', getFeatureUrl: geoserverURL_local, folders: treeFolders1, legendLayers: legendLayers1, show: true});
//region: 'Horowhenua', getFeatureUrl: geoserverURL_local, folders: treeFolders2, legendLayers: legendLayers2, show: false});
//region: 'Ngongotaha DTS', getFeatureUrl: geoserverURL_local, folders: treeFolders3, legendLayers: legendLayers3, show: false});


/* array that stores all overlay layers */
/*TODO move to database and load via proper play databean */
/*TODO rename children to parent! */
/*DIRTY HACK: i fill the id field after creating the layer, to get the ID openlayers is assigning to it */
...
var baseLayerSpecs = [
    ...
    new OpenLayers.Layer.WMS("Linz Topo50", linzwms_URL_new, { layers: 'layer-50767', transparent: false, format: "image/png"}, { isBaseLayer: true, singleTile: false, visibility: true, displayInLayerSwitcher: false, opacity: 1}),
    new OpenLayers.Layer.WMS("Linz Terrain Relief", linzwms_URL_new, { layers: 'layer-50765', transparent: false, format: "image/png"}, { isBaseLayer: true, singleTile: false, visibility: true, displayInLayerSwitcher: false, opacity: 1})
];
...
function initFeatureInfoWindow() {
    ...
    featureInfo = new OpenLayers.Control.WMSGetFeatureInfo({
        id: 'getfeatureinfo',
        queryVisible: true, 
        url: geoserverURL_local, // TODO allow for multiple getfeatureinfo urls!
        /* buffer: clicking tolerance */
        vendorParams: {
            buffer: 10
        },
        eventListeners: {
            getfeatureinfo: showFeatureInfoWindowHtml
        },
 ...
 */
function showFeatureInfoWindowHtml(event) {
 ...
 * this is called from a click event on a map
 */
function showFeatureInfoWindowJson(event) {
    var htmlText = event.text;
